...
light_state curr_state = LIGHT_OFF;
  ...
  switch(curr_state)
  {
    case LIGHT_OFF:
    {
      switch(event)
      {
        case ON:
        {
          light_change_intensity(PIN_LED_9, LIGHT_BRIGHT_DIM);
    ...
    case LIGHT_DIM:
    {
      switch(event)
      {
        case ON:
        {
          light_change_intensity(PIN_LED_9, LIGHT_BRIGHT_MED);
          curr_state = LIGHT_MEDIUM;
          break;
        }
        case OFF:
        {
          light_change_intensity(PIN_LED_9, LIGHT_BRIGHT_OFF);
    ...
    case LIGHT_MEDIUM:
    {
      switch(event)
      {
        case ON:
        {
          light_change_intensity(PIN_LED_9, LIGHT_BRIGHT_FULL);
