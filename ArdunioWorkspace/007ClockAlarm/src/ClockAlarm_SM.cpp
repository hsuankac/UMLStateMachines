...
static QState Clock_Alarm_Clcok_Setting(Clock_Alarm * const me);
...
/*$define${HSMs::super_ClockAlarm} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
static QState Clock_Alarm_Ticking(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case SET_SIG: {
            ...
            status_ = Q_TRAN(&Clock_Alarm_Clcok_Setting);
            break;
        }
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting} .................*/
static QState Clock_Alarm_Clcok_Setting(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_cs_hour_d1);
            break;
        }
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::OK} */
        case OK_SIG: {
            if(me->temp_format != FORMAT_24H){
            ...
            /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::OK::[0]} */
            if (0) {
                status_ = Q_HANDLED();
            }
            else {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d2} .....*/
static QState Clock_Alarm_cs_hour_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d2} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d2::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_cs_min_d1);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Clcok_Setting);
            break;
        }
    }
    return status_;
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d1} .....*/
static QState Clock_Alarm_cs_hour_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d1} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 3;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_hour_d1::OK} */
        case OK_SIG: {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d1} ......*/
static QState Clock_Alarm_cs_min_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d1} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d1::OK} */
        case OK_SIG: {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d2} ......*/
static QState Clock_Alarm_cs_min_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d2} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_min_d2::OK} */
        case OK_SIG: {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d1} ......*/
static QState Clock_Alarm_cs_sec_d1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d1} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d1::OK} */
        case OK_SIG: {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d2} ......*/
static QState Clock_Alarm_cs_sec_d2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d2} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_sec_d2::OK} */
        case OK_SIG: {
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_format} ......*/
static QState Clock_Alarm_cs_format(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_format} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_format::SET} */
        case SET_SIG: {
            String msg;
            if(me->temp_format == FORMAT_24H){
                me->temp_format = FORMAT_AM;
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_format::OK} */
        case OK_SIG: {
            /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_format::OK::[is_time_set_error(me->temp_time~} */
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error} .......*/
static QState Clock_Alarm_cs_error(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_error_on);
            break;
        }
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::SET} */
        case SET_SIG: {
            display_cursor_on_blinkon();
            status_ = Q_TRAN(&Clock_Alarm_Clcok_Setting);
            break;
        }
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::OK} */
        case OK_SIG: {
            status_ = Q_HANDLED();
            break;
        }
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_off}*/
static QState Clock_Alarm_error_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_off} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_off::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_off::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_error_on);
            }
...
/*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_on}*/
static QState Clock_Alarm_error_on(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_on} */
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_on::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*${HSMs::Clock_Alarm::SM::Clock::Settings::Clcok_Setting::cs_error::error_on::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
...
static QState Clock_Alarm_as_err_on(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::as_err_on::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_as_err_on);
            break;
        }
